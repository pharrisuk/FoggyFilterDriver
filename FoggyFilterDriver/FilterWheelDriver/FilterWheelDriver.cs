...
//
// ASCOM FilterWheel driver for FoggyAstroFilterWheel
//
...
namespace ASCOM.FoggyAstroFilterWheel.FilterWheel
{
    ...
    //
    // Your driver's DeviceID is ASCOM.FoggyAstroFilterWheel.FilterWheel
    //
    // The COM Guid attribute sets the CLSID for ASCOM.FoggyAstroFilterWheel.FilterWheel
    // The COM ClassInterface/None attribute prevents an empty interface called _FoggyAstroFilterWheel from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("5c7873b6-9f9a-47d8-99e3-0231d2981fb3")]
    [ProgId("ASCOM.FoggyAstroFilterWheel.FilterWheel")]
    [ServedClassName("ASCOM FilterWheel Driver for FoggyAstroFilterWheel")] // Driver description that appears in the Chooser, customise as required
    ...
    public class FilterWheel : ReferenceCountedObjectBase, IFilterWheelV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FoggyAstroFilterWheel"/> class. Must be public to successfully register for COM.
        /// </summary>
        public FilterWheel()
        {
            try
            {
                ...
                tl = new TraceLogger("", "FoggyAstroFilterWheel.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.FoggyAstroFilterWheel.FilterWheel", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
