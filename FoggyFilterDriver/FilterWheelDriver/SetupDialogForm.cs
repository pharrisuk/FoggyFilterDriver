...
namespace ASCOM.FoggyAstroFilterWheel.FilterWheel
{
    ...
    public partial class SetupDialogForm : Form
    {
        ...
        private void CmdOK_Click(object sender, EventArgs e) // OK button event handler
        {
            ...
            fNames[0] = f0_textBox.Text;
            fNames[1] = f1_textBox.Text;
            fNames[2] = f2_textBox.Text;
            fNames[3] = f3_textBox.Text;
            fNames[4] = f4_textBox.Text;
            FilterWheelHardware.Names = fNames;
        ...
        private void InitUI()
        {
            ...
            fNames = FilterWheelHardware.Names;
            f0_textBox.Text = fNames[0];
            f1_textBox.Text = fNames[1];
            f2_textBox.Text = fNames[2];
            f3_textBox.Text = fNames[3];
            f4_textBox.Text = fNames[4];
